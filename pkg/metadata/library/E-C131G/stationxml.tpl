  ...
  <Network code="{{.NetworkCode}}" startDate="1970-01-01T00:00:00.000000Z" restrictedStatus="open">
    ...
    <Station code="{{.StationCode}}" startDate="1970-01-01T00:00:00.000000Z" restrictedStatus="open">
      ...
      <Channel code="{{.ChannelCode1}}" startDate="1970-01-01T00:00:00.000000Z" restrictedStatus="open" locationCode="{{.LocationCode}}">
        ...
        <Sensor resourceId="Sensor-E-C131G-VEL">
          <Model>LGT-4.5C</Model>
        </Sensor>
        <DataLogger resourceId="Datalogger-E-C131G-VEL"/>
        <Response>
          ...
          <Stage number="1">
            <PolesZeros name="AS-E-C131G-VEL" resourceId="ResponsePAZ-E-C131G-VEL">
              <InputUnits>
                <Name>m/s</Name>
              </InputUnits>
              <OutputUnits>
          ...
          <Stage number="2">
            <Coefficients name="DL-E-C131G-VEL" resourceId="Datalogger-E-C131G-VEL">
              <InputUnits>
                <Name>V</Name>
              </InputUnits>
              <OutputUnits>
      ...
      <Channel code="{{.ChannelCode4}}" startDate="1970-01-01T00:00:00.000000Z" restrictedStatus="open" locationCode="{{.LocationCode}}">
        ...
        <ClockDrift unit="SECONDS/SAMPLE">0.0</ClockDrift>
        <Sensor resourceId="Sensor-E-C131G-ACC">
          <Model>ADXL355BEZ</Model>
        </Sensor>
        <DataLogger resourceId="Datalogger-E-C131G-ACC"/>
        <Response>
          <InstrumentSensitivity>
            <Value>26104.735052234966</Value>
          ...
          <Stage number="1">
            <PolesZeros name="AS-E-C131G-ACC" resourceId="ResponsePAZ-E-C131G-ACC">
              <InputUnits>
                <Name>m/s**2</Name>
              </InputUnits>
              <OutputUnits>
          ...
          <Stage number="2">
            <Coefficients name="DL-E-C131G-ACC" resourceId="Datalogger-E-C131G-ACC">
              <InputUnits>
                <Name>V</Name>
              </InputUnits>
              <OutputUnits>
