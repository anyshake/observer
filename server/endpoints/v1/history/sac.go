...
func (h *History) handleSAC(data []explorer.ExplorerData, stationCode, networkCode, locationCode, channelPrefix, channelCode string) (fileName string, dataBytes []byte, err error) {
	var (
	...
	int32ToFloat32 := func(arr []int32) []float32 {
	...
	sac.SetBody(int32ToFloat32(channelBuffer), startSampleRate)
