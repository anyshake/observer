...
export interface IntensityStandard {
	property: () => Property;
	getIntensity: (data: GetIntensityData, attributes: GetIntensityAttributes) => string;
}
...
export class JMAIntensityStandard implements IntensityStandard {
	...
	getIntensity = ({ currentPGA: pga }: GetIntensityData, _attributes: GetIntensityAttributes) => {
